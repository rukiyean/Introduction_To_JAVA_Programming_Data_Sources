...
public class Course {
	...
	public Course(String courseName) {
		  ...
		  students = new String[100]; // Başlangıç kapasitesi
	       numberOfStudents = 0;
	}
		 
	public void addStudent(String student) {
		 if (numberOfStudents >= students.length) {
	            // Kapasite doldu, dizi büyütülüyor
	 ...
	 public void dropStudent(String student) {
		 ...
		 if (index != -1) {
	            // Öğrenciyi sil ve diğerlerini sola kaydır
	 ...
	 public void clear() {
		 students = new String[100]; // Başlangıç kapasitesine sıfırlanıyor
	        numberOfStudents = 0;
	}
}
